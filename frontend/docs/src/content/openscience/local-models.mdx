...
Open **Settings → Local models**, choose a runtime (or enter a custom URL), and OpenScience discovers and adds the models. It's the same flow as the CLI, backed by your config.
